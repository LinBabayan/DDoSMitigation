...
class AggregationBySrcIP(object):
...
if __name__ == "__main__":
    ...
    output_path = f"{options.train_data_folder}Agg\\AggregateSrcIP\\Wednesday_agg_by_src_ip.csv"
    os.makedirs(f"{options.train_data_folder}Agg\\AggregateSrcIP\\", exist_ok=True)

    processor = AggregationBySrcIP()
